                      ...
                      <li key={link.href}>
                        ...
                        >
                          ...
                          <span className="relative flex items-center gap-3 pl-4">
                            <span className="text-[15px] font-medium text-[#334155] group-hover/link:text-[#123F56] transition-colors">
                              {link.label}
                            </span>
                          </span>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <Link
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #E11D2E 0%, #E11D2E 100%)',
                ...
                <Link
                  href="/contact"
                  onClick={onClose}
                  className="inline-flex items-center gap-2 py-3.5 px-6 rounded-xl font-medium text-[#334155] border-2 border-[#E2E8F0] hover:border-[#E11D2E] hover:text-[#E11D2E] transition-all duration-200"
                >
              ...
              >
                <svg className="w-5 h-5 text-[#64748B] group-hover:text-[#E11D2E] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
