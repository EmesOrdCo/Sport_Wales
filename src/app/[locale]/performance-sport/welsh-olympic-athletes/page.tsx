    ...
    <>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#334155] overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-10 left-10 w-64 h-64 rounded-full bg-[#F59E0B] opacity-10 blur-2xl"></div>
        </div>
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full hidden lg:flex items-center justify-center">
          <div className="w-full h-full bg-gradient-to-l from-[#0F172A]/50 to-transparent flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {athletesBySport.map((sportGroup, index) => (
              <div key={index} className="bg-white rounded-2xl p-6 lg:p-8 border border-[#E2E8F0]">
                <h3 className="text-xl font-display font-bold text-[#0F172A] mb-4 pb-3 border-b border-[#E2E8F0]">
                  {sportGroup.sport}
                </h3>
                <ul className="space-y-2">
                  {sportGroup.athletes.map((athlete, athleteIndex) => (
                    <li key={athleteIndex} className="text-[#475569] hover:text-[#B91C3C] transition-colors cursor-pointer">
                      {athlete}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="aspect-video rounded-2xl bg-gradient-to-br from-[#0F172A] to-[#1E293B] flex items-center justify-center relative overflow-hidden">
              {/* Video placeholder */}
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-[#B91C3C] flex items-center justify-center mx-auto mb-4 cursor-pointer hover:bg-[#991B1B] transition-colors">
            ...
            <div className="mt-4 text-center">
              <a href="#" className="text-[#B91C3C] hover:underline text-sm font-medium">
