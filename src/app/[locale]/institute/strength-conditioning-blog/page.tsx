      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="container">
          <div className="max-w-3xl">
            ...
            <h2 className="text-xl font-display font-bold text-[#0F172A] mb-4 mt-10">Why is this strength & conditioning course needed?</h2>
            ...
            <h2 className="text-xl font-display font-bold text-[#0F172A] mb-4 mt-10">Why is this important now? The challenges facing our athletes…</h2>
            ...
            <h2 className="text-xl font-display font-bold text-[#0F172A] mb-4 mt-10">So, what is the course?</h2>
            ...
            <h2 className="text-xl font-display font-bold text-[#0F172A] mb-4 mt-10">How can I register for the strength & conditioning qualification?</h2>

            <p className="text-[#475569] mb-6">
              If you'd like to find out more about the qualification and how it could benefit you or your organisation, please email <a href="mailto:seb.moran@sport.wales" className="text-[#B91C3C] hover:underline">seb.moran@sport.wales</a>
            </p>
